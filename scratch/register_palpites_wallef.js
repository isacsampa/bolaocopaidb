...
Coreia do Sul 1 x 1 República Tcheca
República Tcheca 2 x 1 África do Sul
México 1 x 1 Coreia do Sul
República Tcheca 2 x 1 México
...
Grupo G
Bélgica 2 x 0 Irã
Egito 1 x 1 Nova Zelândia
Bélgica 2 x 1 Nova Zelândia
Egito 1 x 1 Irã
Bélgica 2 x 0 Egito
Irã 2 x 0 Nova Zelândia
Grupo H
Espanha 4 x 0 Cabo Verde
Arábia Saudita 0 x 2 Uruguai
Espanha 3 x 0 Uruguai
Cabo Verde 0 x 2 Arábia Saudita
Espanha 2 x 1 Arábia Saudita
Cabo Verde 0 x 0 Uruguai
Grupo I
França 2 x 1 Senegal
Iraque 0 x 2 Noruega
França 3 x 0 Noruega
Senegal 1 x 1 Iraque
França 2 x 0 Iraque
Senegal 0 x 0 Noruega
Grupo J
Argentina 2 x 0 Argélia
Áustria 0 x 1 Jordânia
Argentina 2 x 0 Jordânia
...
Portugal 2 x 0 Colôbiia
RD Congo 0 x 3 Uzbequistão
Portugal 1 x 1 Uzbequistão
RD Congo 0 x 0 Colômbia
Grupo L
...
async function run() {
  // 1. Procurar perfil por wallef
  console.log("🔍 Buscando perfil do Wallef no banco...");
  ...
  const wallef = perfis.find(p => p.nome.toLowerCase().includes("wallef"));

  if (!wallef) {
    console.error("❌ Usuário 'Wallef' não encontrado no banco de dados.");
    console.log("Lista de usuários cadastrados:");
    perfis.forEach(p => console.log(` - ID: ${p.id} | Nome: ${p.nome}`));
    return;
  }

  console.log(`✅ Usuário encontrado: ID: ${wallef.id} | Nome: ${wallef.nome}\n`);
